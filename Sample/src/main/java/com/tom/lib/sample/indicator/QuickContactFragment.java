package com.tom.lib.sample.indicator;
...
public class QuickContactFragment extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tabs = (PagerIndicator) root.findViewById(R.id.tabs);
	...
	public class ContactPagerAdapter extends PagerAdapter implements PagerIndicator.IconTabProvider {
