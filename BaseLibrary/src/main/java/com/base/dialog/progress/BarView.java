...
class BarView extends View implements Determinate {
    ...
    private void init() {
        ...
        mOuterPaint.setStrokeWidth(UIToos.dpToPixel(2, getContext()));
        ...
        mBoundGap = UIToos.dpToPixel(5, getContext());
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int padding = UIToos.dpToPixel(2, getContext());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthDimension = UIToos.dpToPixel(100, getContext());
        int heightDimension = UIToos.dpToPixel(20, getContext());
