...
public class ProgressView {
     ...
     */
    public static ProgressView create(Context context) {
        return new ProgressView(context);
    }

  /**
   * Create a new HUD. specify the HUD style (if you use a custom view, you need {@code ProgressView.create(Context context)}).
   *
   * @param context Activity context that the HUD bound to
   * @param style One of the ProgressView.Style values
   * @return An unique HUD instance
   */
    public static ProgressView create(Context context, Style style) {
        return new ProgressView(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public ProgressView setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public ProgressView setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public ProgressView setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public ProgressView setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public ProgressView setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public ProgressView setLabel(String label) {
     ...
     * @return Current HUD
     */
    public ProgressView setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public ProgressView setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public ProgressView setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public ProgressView setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public ProgressView setAutoDismiss(boolean isAutoDismiss) {
    ...
    private class ProgressDialog extends Dialog {
        ...
        private void updateBackgroundSize() {
            ...
            params.width = UIToos.dpToPixel(mWidth, getContext());
            params.height = UIToos.dpToPixel(mHeight, getContext());
