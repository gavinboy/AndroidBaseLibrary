...
class PieView extends View implements Determinate {
    ...
    private void init(){
        ...
        mWhitePaint.setStrokeWidth(UIToos.dpToPixel(0.1f, getContext()));
        mWhitePaint.setColor(Color.WHITE);

        mGreyPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mGreyPaint.setStyle(Paint.Style.STROKE);
        mGreyPaint.setStrokeWidth(UIToos.dpToPixel(2, getContext()));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int padding = UIToos.dpToPixel(4, getContext());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int dimension = UIToos.dpToPixel(40, getContext());
